...
function logGraphQLErrors(fetchResponse) {
  if (fetchResponse?.errors?.length) {
    console.error('Contentful GraphQL errors:', fetchResponse.errors);
  }
}

function extractPost(fetchResponse) {
  logGraphQLErrors(fetchResponse);
